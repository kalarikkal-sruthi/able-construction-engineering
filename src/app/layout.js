...
export const metadata = {
  title: "Able Group Developers | Global Construction & Development Group Since 1992",
  description: "Able Group is a global conglomerate with 30+ years of excellence in construction, infrastructure, trading, and sustainable agribusiness across India, Middle East & East Africa.",
  keywords: "construction, infrastructure, real estate, development, sustainable agribusiness, trading, Qatar, Saudi Arabia, UAE, India, Uganda, building, development group, Able Group",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "Able Group Developers | Global Construction & Development Group Since 1992",
    description: "30+ years of excellence in construction, infrastructure, and sustainable development across multiple continents.",
  ...
  twitter: {
    ...
    description: "Building landmarks and nurturing communities since 1992 across India, Middle East, and East Africa.",
