...
const businessVerticals = [
  {
    title: "Construction",
    icon: "🏗️",
    description: "Comprehensive civil engineering and infrastructure development services",
    highlights: [
  ...
  },
  {
    title: "Trading",
    icon: "📦",
    description: "Wholesale and retail distribution of building materials and industrial supplies",
    highlights: [
  ...
  },
  {
    title: "Agribusiness",
    icon: "🌱",
    description: "Sustainable farming and integrated food production in Kerala",
    highlights: [
...
<div className="">
  {/* Hero Section */}
  <section className="relative py-20 bg-gradient-to-r from-blue-900 to-green-900 text-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <div className="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
            <span className="text-sm">Est. 1992</span>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
            <span className="text-sm">20+ Years Experience</span>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
            <span className="text-sm">3 Business Verticals</span>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
            <span className="text-sm">International Presence</span>
          </div>
        </motion.div>
      </div>
    </div>
  ...
  <section className="py-16 bg-white">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Business Verticals</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6">
              Able Group is a diversified business conglomerate operating for over 20 years across 
              India and the Middle East. With strong management capabilities, we excel in three 
              core business verticals: Construction, Trading, and Agribusiness.
            </p>
            <div className="space-y-3">
              <div className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                <span className="text-gray-700">Complex construction project execution</span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                <span className="text-gray-700">Comprehensive trading and supply chain</span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                <span className="text-gray-700">Sustainable agricultural practices</span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Able Farms Pvt. Ltd.</h3>
              <p className="mb-4">
                Our agricultural division focuses on sustainable farming practices and integrated 
                food production in the biodiverse hills of Kerala.
              </p>
              <div className="space-y-3">
                <div className="flex items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-6">
              Able Farms represents our commitment to sustainable agriculture and food production. 
              Nestled in the biodiverse hills of Kerala, we focus on creating synergistic ecosystems 
              that deliver fresh, high-quality produce to local and regional markets.
            </p>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-green-50 rounded-lg p-4 text-center">
                <div className="text-2xl font-bold text-green-600">🌍</div>
                <div className="font-semibold text-green-800">Sustainable</div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Mr. Yakkoob Purayil</h3>
              <p className="text-green-600 font-semibold mb-2">Chairman & Founder</p>
              <p className="text-gray-600 text-sm">
                With over 30 years of experience across construction, trading, and agriculture, 
                Mr. Purayil has successfully expanded the group&apos;s operations globally.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Mr. Muhammad Basheer</h3>
              <p className="text-green-600 font-semibold mb-2">CEO</p>
              <p className="text-gray-600 text-sm">
                Leading the technical front with vast experience in construction engineering 
                and successful project performance across various government departments.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Mr. Ishaque Purayil</h3>
              <p className="text-green-600 font-semibold mb-2">Board Director</p>
              <p className="text-gray-600 text-sm">
                Bringing technical expertise and strategic vision to drive the company&apos;s 
                growth across all business verticals including agribusiness.
              </p>
            </motion.div>
          </div>
        </div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Construction Services</h2>
          <p className="text-lg text-gray-600">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Trading Division</h2>
            <p className="text-lg text-gray-600 mb-6">
              Our trading operations span across multiple countries, providing comprehensive 
              supply chain solutions for construction and industrial needs.
            </p>
            <div className="space-y-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h4 className="font-bold text-gray-900 mb-2">Building Materials</h4>
                <p className="text-gray-600 text-sm">Wholesale and retail distribution of construction materials</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h4 className="font-bold text-gray-900 mb-2">Industrial Supplies</h4>
                <p className="text-gray-600 text-sm">Power tools, safety equipment, and industrial hardware</p>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <h4 className="font-bold text-gray-900 mb-2">Fuel & Energy</h4>
                <p className="text-gray-600 text-sm">Diesel trading and energy solutions for commercial sectors</p>
              </div>
            </div>
          </motion.div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Global Footprint</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {countries.map((country, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-300 mt-2">Since {country.established}</p>
            </motion.div>
          ))}
        </div>
      </div>
  ...
  <section className="py-16 bg-gradient-to-r from-blue-600 to-green-600 text-white">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Whether it's construction, trading, or agriculture - let's build success together.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
