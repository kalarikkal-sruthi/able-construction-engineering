                ...
                >
                  <div className="mb-3 sm:mb-4 lg:mb-6 text-center">
                    ...
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block  mb-3 mt-3 sm:mb-3 text-white">
                      Since our foundation in <strong>1992</strong>, the Able
                      Group has been built on a legacy of excellence and
                      strategic growth. We have since evolved into a dynamic
                      international conglomerate, defining skylines and powering
                      industries across{" "}
                      <strong>India, the Middle East, and East Africa</strong>.
                    </p>
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block  mb-3 mt-3 sm:mb-3 text-white">
                      ...
                      essential construction materials and industrial fuel
                      through established trading networks in{" "}
                      <strong>Qatar and Saudi Arabia</strong>; and cultivators,
                      advancing sustainable agribusiness from the farmlands of{" "}
                      <strong>Wayanad</strong> to the emerging coffee
                      plantations of
                      <strong> Uganda</strong>.
                    </p>
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block  mb-3 mt-3 sm:mb-3 text-white">
                      Driven by{" "}
                      <strong>three decades of unwavering commitment</strong>,
                      we do not merely complete projects—we build legacies of
                      quality, reliability, and trust, from the ground up.
                    </p>
                  </div>
                </motion.h1>
              </header>
          ...
          <div className=" mx-auto px-4 sm:px-6 lg:px-16 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <article className="space-y-4 my-0">
                  ...
                  <div className="prose prose-lg max-w-none">
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block mt-2 md:mt-3 sm:mt-2 mb-4 md:mb-8 sm:mb-3 text-black">
                      ...
                      <strong>Middle East and India</strong> to premium
                      residential spaces in emerging markets—is unified by a
                      single, uncompromising standard:{" "}
                      <strong>excellence</strong>.
                    </p>
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block mt-2 md:mt-3 sm:mt-2 mb-4 md:mb-8 sm:mb-3 text-black">
                      Our strength is amplified by a{" "}
                      <strong>fully integrated supply chain</strong>. Through
                      our established trading divisions in Qatar and Saudi
                      Arabia, we are direct suppliers of essential construction
                      materials and industrial fuel. This unique capability
                      guarantees project integrity, ensures timely delivery, and
                      provides a competitive edge that sets us apart.
                    </p>
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block mt-2 md:mt-3 sm:mt-2 mb-4 md:mb-8 sm:mb-3 text-black">
                      Our vision for growth extends beyond construction. We are
                      cultivating prosperity through{" "}
                      <strong>sustainable agribusiness</strong>, from integrated
                      farming initiatives in <strong>Wayanad, India</strong>, to
                      our new venture in premium coffee cultivation for export
                      in <strong>Uganda</strong>. This deep-rooted commitment
                      allows us to nurture communities and create lasting value
                      from the ground up.
                    </p>
                    <p className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block mt-2 md:mt-3 sm:mt-2 mb-4 md:mb-8 sm:mb-3 text-black">
                      We are more than a construction company; we are a{" "}
                      <strong>holistic partner in development</strong>,
                      dedicated to transforming visions into enduring realities
                      that empower communities and inspire generations.
                    </p>
                  </div>
                </article>
              ...
              <div
                className="relative"
                role="img"
                aria-label="Able Group business meeting in progress"
              >
