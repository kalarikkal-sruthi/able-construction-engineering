...
export default function Home() {
  return (
    <main>
        ...
        <div className="flex gap-6 items-center">
          ...
          <div className="w-3/5 relative h-160">
            <Image
              ...
              fill
              className="object-contain rounded-8xl"
            />
          </div>
        </div>
        <div>
      ...
      <section className="flex flex-col items-center justify-center bg-[#b2b2b1]  text-gray-800  pt-25 pl-25 pb-20 pr-25">
        <h2 className="text-5xl font-bold text-white mb-6 text-center -mr-12">
          We deliver
          <br></br>{" "}
          <span className="text-[#251f77]">smart building projects</span>
        </h2>
      </section>
      <section className="grid grid-cols-3 gap-20 pl-25 pb-20 pr-25 relative bg-[#b2b2b1] ">
        <div className="bg-white rounded-xl text-center">
          ...
          <div className="mt-10 mb-10">
            <h1 className="mb-4 text-black text-4xl ">Riverwalk towers</h1>
            <p>
              {" "}
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry.
