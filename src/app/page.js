...
export default function Home() {
  return (
    <>
      <Head>
        <title>
          Able Group Developers | Global Construction & Development Group Since
          1992
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="construction, infrastructure, real estate, development, sustainable agribusiness, trading, Qatar, Saudi Arabia, UAE, India, Uganda"
        />
        <meta
          name="robots"
        ...
        <meta
          property="og:title"
          content="Able Group Developers | Global Construction & Development Group Since 1992"
        />
        <meta
          property="og:description"
          content="30+ years of excellence in construction, infrastructure, and sustainable development across multiple continents."
        />
        <meta property="og:url" content="https://ablegroupdevelopers.com/" />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content="https://ablegroupdevelopers.com/og-image.jpg"
        />
        <meta
          property="og:image:alt"
          content="Able Group Developers - Building Legacies Since 1992"
        />
        ...
        <meta
          name="twitter:title"
          content="Able Group Developers | Global Construction & Development Group"
        />
        <meta
          name="twitter:description"
          content="Building landmarks and nurturing communities since 1992 across India, Middle East, and East Africa."
        />
        <meta
          name="twitter:image"
          content="https://ablegroupdevelopers.com/twitter-image.jpg"
        />
              ...
              >
                <div className="mb-3 sm:mb-4 lg:mb-6 text-center">
                  ...
                  <span className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block  mb-3 mt-3 sm:mb-3 text-white">
                    Since our foundation in 1992, the Able Group has been built
                    on a legacy of excellence and strategic growth. We have
                    since evolved into a dynamic international conglomerate,
                    defining skylines and powering industries across India, the
                ...
                <div className="space-y-4 my-0">
                  <div className="text-start">
                    ...
                    <span className="text-[12px] sm:text-[16px] lg:text-[16px] xl:text-[16x] block   mt-2 md:mt-3 sm:mt-2 mb-4 md:mb-8 sm:mb-3 text-black">
                      ...
                      in Uganda. This deep-rooted commitment allows us to
