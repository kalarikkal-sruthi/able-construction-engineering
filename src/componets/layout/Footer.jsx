      ...
      <div className="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12 xl:gap-14">
        ...
        <div className=" sm:text-left">
          ...
          <ul className="space-y-2 sm:space-y-3 text-gray-300 sm-display-flex">
            ...
            <li>
              <a href="#" className="hover:text-white transition-colors duration-300 text-[12px] sm:text-[14px] lg:text-[14px] xl:text-[14x]">About Us</a>
            </li>
            <li>
              <a href="#" className="hover:text-white transition-colors duration-300 text-[12px] sm:text-[14px] lg:text-[14px] xl:text-[14x]">Business Plan</a>
            </li>
            <li>
              <a href="#" className="hover:text-white transition-colors duration-300 text-[12px] sm:text-[14px] lg:text-[14px] xl:text-[14x]">Our Works</a>
            </li>
            <li>
              <a href="#" className="hover:text-white transition-colors duration-300 text-[12px] sm:text-[14px] lg:text-[14px] xl:text-[14x]">Company Profile</a>
            </li>
            <li>
              <a href="#" className="hover:text-white transition-colors duration-300 text-[12px] sm:text-[14px] lg:text-[14px] xl:text-[14x]">Contact</a>
            </li>
          </ul>
        </div>
